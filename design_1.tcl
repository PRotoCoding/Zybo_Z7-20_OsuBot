...
xilinx.com:hls:nodeDetector:1.0\
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net nodeDetector_0_out0_V [get_bd_pins nodeDetector_0/out0_V] [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_2/In0]
  connect_bd_net -net nodeDetector_0_out1_V [get_bd_pins nodeDetector_0/out1_V] [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconcat_2/In1]
  connect_bd_net -net nodeDetector_0_out2_V [get_bd_pins nodeDetector_0/out2_V] [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconcat_2/In2]
  connect_bd_net -net nodeDetector_0_out3_V [get_bd_pins nodeDetector_0/out3_V] [get_bd_pins xlconcat_1/In3] [get_bd_pins xlconcat_2/In3]
  connect_bd_net -net nodeDetector_0_out4_V [get_bd_pins nodeDetector_0/out4_V] [get_bd_pins xlconcat_2/In4]
  connect_bd_net -net nodeDetector_0_out5_V [get_bd_pins nodeDetector_0/out5_V] [get_bd_pins xlconcat_2/In5]
  connect_bd_net -net nodeDetector_0_out6_V [get_bd_pins nodeDetector_0/out6_V] [get_bd_pins xlconcat_2/In6]
  ...
  connect_bd_net -net xlconcat_1_dout [get_bd_ports leds] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconcat_2_dout [get_bd_pins axi_gpio_detect/gpio_io_i] [get_bd_pins xlconcat_2/dout]
