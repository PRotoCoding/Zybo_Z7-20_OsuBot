...
if {[file isfile nodeDetector.autotvin.dat]} {
	file delete -force nodeDetector.autotvin.dat
}

if {[file isfile nodeDetector.autotvout.dat]} {
	file delete -force nodeDetector.autotvout.dat
}
