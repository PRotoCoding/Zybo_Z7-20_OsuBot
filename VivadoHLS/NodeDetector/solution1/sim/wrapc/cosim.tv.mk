...
$(ObjDir)/nodedetectorTest.cpp_pre.cpp.tb.o : nodedetectorTest.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling nodedetectorTest.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/nodedetector.cpp_pre.cpp.tb.o : nodedetector.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling nodedetector.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
