...
set Library     "hls"
set IPName      "nodeDetector"
set Version     "1.0"
set DisplayName "Nodedetector"
set Revision    "1905232126"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set has_xpm_memory "0"
set sdx_kernel_name "nodeDetector"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set xo_hls_files_dir ""
set hdl_module_list {nodeDetector_CRTL_BUS_s_axi
nodeDetector
}
set kernel_xo ""

## Variables
set Top "nodeDetector"
set TopNoPrefix "nodeDetector"
...
set Interfaces {
    s_axi_CRTL_BUS {
        ...
        registers {{0x10 enable_V W 0x0 "Data signal of enable_V" {{0 8 enable_V W 0 "Bit 7 to 0 Data signal of enable_V"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 pos_0_V W 0x0 "Data signal of pos_0_V" {{0 16 pos_0_V W 0 "Bit 15 to 0 Data signal of pos_0_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 pos_1_V W 0x0 "Data signal of pos_1_V" {{0 16 pos_1_V W 0 "Bit 15 to 0 Data signal of pos_1_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 pos_2_V W 0x0 "Data signal of pos_2_V" {{0 16 pos_2_V W 0 "Bit 15 to 0 Data signal of pos_2_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 pos_3_V W 0x0 "Data signal of pos_3_V" {{0 16 pos_3_V W 0 "Bit 15 to 0 Data signal of pos_3_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 pos_4_V W 0x0 "Data signal of pos_4_V" {{0 16 pos_4_V W 0 "Bit 15 to 0 Data signal of pos_4_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 pos_5_V W 0x0 "Data signal of pos_5_V" {{0 16 pos_5_V W 0 "Bit 15 to 0 Data signal of pos_5_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 pos_6_V W 0x0 "Data signal of pos_6_V" {{0 16 pos_6_V W 0 "Bit 15 to 0 Data signal of pos_6_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 horizontalPos_V W 0x0 "Data signal of horizontalPos_V" {{0 16 horizontalPos_V W 0 "Bit 15 to 0 Data signal of horizontalPos_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 7.5 machine 64 combinational 0 latency 921605 II x}
